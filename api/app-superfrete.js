...
module.exports = async function handler(request, response) {
  try {
    ...
    const superfreteTag = '<script src="/superfrete-upgrade.js?v=20260817-0950-origin-selector"></script>';
    const virtualChatTag = '<script src="/virtual-chat-description-fix.js?v=20260817-0835-chat-buy-bag"></script>';
