...
module.exports = async function handler(request, response) {
  try {
    ...
    html = removeScript(html, 'catalog-seller-simplify.js');
    ...
    const sellerFirstTag = '<script src="/catalog-seller-simplify.js?v=20260819-1839-seller-first"></script>';
    let inject = '';
