...
function installStyle(main,bg,accent){
  ...
  @media(max-width:520px){#pubChatToggle.chatshop-virtual-seller-pill{right:12px!important;bottom:16px!important;min-width:166px!important;height:50px!important;padding:0 14px!important}.cdc-panel{height:92dvh}.cdc-bubble{max-width:88%}}
